  ...
  const experiences = [
    {
      ...
      description:
        "Developed responsive and mobile-friendly web applications using HTML, CSS, and React.js. Built and maintained RESTful APIs with Node.js and Express.js, ensuring smooth frontend-backend integration and improved overall application performance.",
    },
    {
      id: 2,
      type: "work",
      ...
      description:
        "Handled employee data management using Excel and ERP systems, prepared reports and shift schedules, maintained records, and supported daily production operations to improve workflow efficiency and data accuracy.",
    },
    {
      id: 3,
      type: "education",
      ...
      duration: "2018 – 2021",
      description:
        "Gained strong foundations in programming, web development, and database management with a focus on practical implementation and real-world problem solving.",
    },
  ];
